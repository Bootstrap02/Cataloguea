...
//     try {
//       const res = await axios.get(`${API}/betking`);
//       if (Array.isArray(res.data) && res.data[0]?.base) {
//         setBaseStake(res.data[0].base);
//       }
//     } catch (err) {
//       console.warn("Failed to fetch base:", err.message);
//     }
//   };
...
//       try {
//         await axios.put(`${API}/betking`, { base: baseStake });
//       } catch (err) {
...
//     try {
//       await axios.put(`${API}/betking`, { base: baseStake });
//       alert("Base saved successfully");
//     } catch (err) {
//       alert("Save failed. Network issue.");
//     }
//   };
