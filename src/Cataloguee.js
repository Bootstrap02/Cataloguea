...
//     // Protection: subtract 900 from bank to reduce high deficits
//     const allDeficits = {
...
//       if (def >= 1000) {
//         const reduction = 900;
//         bankDeduction += reduction;

//         if (key === "winner") {
//         //   setBadGamesDeficit((prev) => Math.max(0, prev - reduction));
//         console.log("Jackpot!")
//         } else {
//           setSpecialDeficits((prev) => ({
//             ...prev,
//             [key]: Math.max(0, prev[key] - reduction),
//           }));
//         }
//       }
//     });
...
//     if (bankDeduction > 0) {
//       setDeficitBank((prev) => Math.max( prev - bankDeduction, 0));
//     }
